    ...
    const registerHandler = async (e) => {
        ...
        try {
          const { data } = await axios.post(
            ...
            { username, email, firstName, lastName, country, password },
            config
          );
            ...
            <div className="flex justify-center mt-16 mb-10">
                ...
                <div className="bg-white container mx-80 max-sm:mx-2 px-3 rounded-xl">
                    ...
                    <div className="group mt-5 flex justify-center">
                     ...
                     <select id="country" name="country" className="bg-gray-100 mt-5 h-10 input  max-sm:w-full" value={country} onChange={(e) => {setCountry(e.target.value);}} required>
