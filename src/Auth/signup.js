...
function Signup () {
    ...
    const handleChange = (e) => {
        ...
        switch (name) {
            case 'username':
                setEmptyUsername(value === '');
                break;
            case 'email':
                setEmptyEmail(value === '');
                break;
            case 'firstName':
                setEmptyFirstName(value === '');
                break;
            case 'lastName':
                setEmptyLastName(value === '');
                break;
            case 'password':
                setEmptyPassword(value === '');
                break;
            case 'confirmPassword':
                setEmptyConfirmPassword(value === '');
                break;
            case 'country':
                setEmptyCountry(value ==='');
                break
            default:
                break;
        }
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (response.status === 400) {
                    if (responseData.error === 'Email is taken') {
                    ...
                    } else if (responseData.error === 'Username is taken') {
        ...
        <div className="">
            ...
            <div className="flex justify-center mt-16 mb-10">
                ...
                <div className="bg-white container mx-80 max-sm:mx-2 px-3 rounded-xl">
                    ...
                    {emptyUsername && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>Username is required</p>}
                    {usernameError && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>{usernameError}</p>}
                    ...
                    {emptyEmail && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>Email is required</p>}
                    {emailError && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>{emailError}</p>}
                    ...
                    {emptyFirstName && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>First Name is required</p>}
                    ...
                    {emptyLastName && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>Last Name is required</p>}
                    ...
                    {emptyPassword && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>Password is required</p>}
                    ...
                    {emptyConfirmPassword && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>Confirm Password is required</p>}
                    ...
                    {emptyCountry && <p className="text-red-500 mb-3 absolute" style={{zIndex: "999"}}>Username is required</p>}
