    ...
    return(
        <div className="mt-20">
           <div>
            ...
            <div className="bg-white w-1/2 p-2 mt-10 sm-max:w-80">
            ...
            <p className="text-left dark:text-white mt-5 flex text-xs sm-max:flex-col">Default Affiliate Link: <p className="underline">https://portal.sanieldanproperties.com/sign-up/?ref=31</p></p>
           </div>
           ...
           <div className="mt-16">
            ...
            <div class=" text-left mt-10" >
               ...
               <label for="select" className=""  >Campaign:</label><br/>
                <select name="select" class="placeholder-violet-700 text-sm font-bold rounded-lg focus:ring-violet-500 focus:border-violet-500 w-1/2 p-2.5 sm-max:w-80">
            ...
            <div class="coolinput mt-5">
                ...
                <input type="text" placeholder="Type your web link here ..." name="input" className="input sm-max:w-80" />
            </div>
